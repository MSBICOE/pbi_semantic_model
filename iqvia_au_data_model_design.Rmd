...
* Dim_Channel 
* Dim_Banner (in rare cased, a client might only access to a certain banners, this can be considered later)
* Dim_Banner_State
* Dim_State
* Dim_Brick
...
vw_ClientName_TableName

A complete set of view names for PBI model as below:


* vw_ClientName_Dim_Store
* vw_ClientName_Dim_Banner_Store_Period
* vw_ClientName_Dim_Banner
* vw_ClientName_Dim_Banner_State
* vw_ClientName_Dim_State
* vw_ClientName_Dim_Brick
* vw_ClientName_Dim_Product (Base Joining to ClientName_Dim_Product_Client)
* vw_ClientName_Dim_Date_Base (Only includes the dates in Dim_Date_Client)
* vw_ClientName_Dim_Sellin_Scanout (Only includes the years in Dim_Date_Client)
* vw_ClientName_Dim_Product_Client
* vw_ClientName_Dim_Date_Client
* vw_ClientName_Other_Client_Dimensions(++)
* vw_ClientName_Fact_Banner_Brick_Sales (Base Joining to vw_ClientName_Dim_Product, vw_ClientName_Dim_Date_Base)
* vw_ClientName_Fact_Store_Sales (Base Joining to vw_ClientName_Dim_Product, vw_ClientName_Dim_Date_Base)
* vw_ClientName_Fact_Grocery_IRI_Distribution
