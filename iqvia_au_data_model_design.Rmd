...
## Sellin_Scan Dimension Table

This is a very simple dimension table to separate the fact data into sellin and scanout partition. 

To separate the sellin and scanout into different partitions in the fact table renders the different frequency of updates of sellin/scanout data possiple. This means we can update sellin and scanout data in the same fact table in the different cadence without reloading everything. This can save a significant data refreshing time.
