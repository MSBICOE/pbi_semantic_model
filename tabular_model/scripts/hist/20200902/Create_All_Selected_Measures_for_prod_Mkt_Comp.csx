foreach(var m in Selected.Measures) {
    var prod_dax = "calculate([$$$$ All Selected], filter(all('Dim_Product'), 'Dim_Product'[Product Ownership] = \"Own Products\"))";
    var mkt_dax = "CALCULATE ( [$$$$ All Selected], ALL ( 'Dim_Product'[Product Ownership]) )";
    var comp_dax = "calculate([$$$$ All Selected], filter(all('Dim_Product'), 'Dim_Product'[Product Ownership] = \"Competitor\"))";
