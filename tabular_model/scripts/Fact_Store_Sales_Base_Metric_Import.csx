var targetTable = Model.Tables["Fact_Store_Sales"];  // Name of the table that should hold the measures

var measureMetadata = ReadFile(@"C:/Users/steven.wang/Documents/PBI_Semantic/Fact_Store_Sales_Base_Measure_Import.txt"); 
...
foreach(var row in tsvRows.Skip(1))
{
    ...
    measure.DisplayFolder = "Base Metrics";
