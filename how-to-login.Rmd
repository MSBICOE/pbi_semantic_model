...
IQVIA will supply a preconfigured Excel workbook for you to connect to your dataset from IQVIA cloud space.
...
Fill in a user name as in Figure \@ref(fig:login1):
...
Fill in a password as in Figure \@ref(fig:login2):
